        ...
        <div className="flex justify-between items-center mb-6">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-xl font-semibold">
              {type == "create" ? "Add New " : "Edit "} Timer
            </h2>
          </div>
          <button
            onClick={handleClose}
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex justify-end gap-3 pt-4 border-t">
            <CustomButton
              ...
              additionalClasses="text-gray-700 bg-gray-100 rounded-md hover:bg-gray-200"
            />
            <CustomButton
              type="submit"
              label={type == "create" ? "Add Timer" : "Save Changes"}
              additionalClasses={"text-white bg-blue-600 hover:bg-blue-700"}
            />
          </div>
        </form>
      </div>
